...
3.  在弹出的窗口中单击输入框后方的![](figures/icon-more.png)，选择格式为\*.jmx的文件，单击“导入“，导入成功后将自动“关闭”窗口并返回“测试计划“页签，可以看到已添加的测试计划。

    **图 1**  导入jmx文件<a name="fig02435522553"></a>  
    ![](figures/导入jmx文件.png "导入jmx文件")
...
4.  在“测试计划“页签中，单击“第三方Jar包”，在弹出的窗口中单击“本地导入“，选择测试计划所依赖的JAR包并导入，导入成功后将自动“关闭”窗口并返回“测试计划“页签。
    ...
    **图 2**  导入JAR包<a name="fig09006017819"></a>  
...
3.  在弹出的窗口中单击“启动调试”，选择资源组后单击“调试“，如[图3](#fig12991031110)所示。

    **图 3**  选择资源组<a name="fig12991031110"></a>  
...
4.  在“调试日志”页签，查看调试的操作日志。
    ...
    **图 4**  调试日志<a name="fig446101154314"></a>  
...
5.  调试完成后，在“结果”页签，查看测试计划调试的具体内容。
    ...
    **图 5**  查看调试结果<a name="fig35739014420"></a>  
...
4.  在“启动测试任务”对话框中，选择“资源组类型”，如[图6](#fig47991765519)所示。

    **图 6**  选择资源组类型<a name="fig47991765519"></a>  
...
2.  在“测试计划“页签中，选中多个需要启动的测试计划，单击“批量启动”。
    ...
    **图 7**  批量启动<a name="fig1140172263515"></a>  
...
3.  在弹出的“编辑测试计划“窗口中，重新导入格式为\*.jmx的文件，单击“关闭”。
    ...
    **图 8**  编辑测试计划<a name="fig336381810520"></a>  
    ![](figures/编辑测试计划.png "编辑测试计划")

4.  单击测试计划名称后的变量文件，可重新导入测试计划需要引用的文件。

    **图 9**  修改变量文件<a name="fig14363111915541"></a>  
...
2.  在“测试计划“页签中，单击待删除测试计划后的“更多 \> 删除”。或选中多个测试计划，单击“批量删除”，一次性删除多个测试计划。
    ...
    **图 10**  删除与批量删除测试计划<a name="fig543419299459"></a>  
...
3.  在弹出的编辑线程组窗口中，可修改并发数、压测时长、预热时间和循环次数，也可点选开启或关闭“无限循环“和“设置时长“。
    ...
    **图 11**  编辑线程组<a name="fig1471431510513"></a>  
...
2.  在“测试计划“页签中，单击待导出jmx文件的测试计划后的“更多 \> 导出”。
    ...
    **图 12**  导出jmx文件<a name="fig947704983613"></a>  
...
4.  在待导出变量文件所在行，单击“导出”。
    ...
    **图 13**  导出变量文件<a name="fig9514204843012"></a>  
...
6.  在待导出的JAR包所在行，单击“导出”。
    ...
    **图 14**  导出JAR包<a name="fig13593951143112"></a>  
