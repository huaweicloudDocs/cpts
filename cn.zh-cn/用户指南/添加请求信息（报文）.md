...
4.  请求类型设置为“报文“。
    -   当“用例类型”为“常规用例”或“预置用例”时，参照[表1](#table178291225164211)设置基本信息。
        ...
        **表 1**  请求类型为报文
        ...
        <a name="ol1454285414318"></a><a name="ol1454285414318"></a><ol id="ol1454285414318"><li>“变量类型”为“枚举”。</li><li>只能有一个值，且为数字的字符串。</li><li>该数字的范围为<span>20ms到60s</span>。</li></ol>
        </div></div>
        </td>
        </tr>
